...
This repository implements a Local Reconstruction Codes (LRC) prototype with a client–proxy–coordinator–datanode architecture. It provides binaries to encode data into stripes, distribute blocks, and repair failures using Jerasure-based LRC routines.
