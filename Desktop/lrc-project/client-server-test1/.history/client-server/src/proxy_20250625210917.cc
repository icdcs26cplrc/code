...
void Proxy::Repair_degrade(string message, int value_get_num, int *node_id, const int *offset_value, const size_t *repair_value_len, string &value,  char **data_alredy_get)
{
    // parse value
