...
bool NewLRC::single_decode(int fail_one, char **data_ptrs, char **code_ptr)
{
...
bool NewLRC::muti_single_decode(int fail_num, int *fail_list, char **data_ptrs, char **global_ptrs, char **local_ptr)
{
