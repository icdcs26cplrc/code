...
void Proxy::Repair_degrade(string message, int value_get_num, int *node_id, const int fail_offset,const size_t fail_value_len_, const int *offset_value, size_t *repair_value_len, string &value)
{
    // parse value
