...
namespace ClientServer {
    ...
    public:
        ...
        void Repair_degrade(std::string message,int num,const int *node_id,const int *offset,const size_t* value_len,string &value, char ** data_already_get);
    ...
    private:
        ...
        void compute_degrade_offsets_and_lens(const int node_need_num,const int fail_num,const size_t blocksize,const std::vector<int>& first_get_node_ids ,const std::vector<int>& fail_node_ids, const std::vector<int>& degrade_get_node_ids ,const std::vector<int>& offsets, const std::vector<size_t>& value_lens, std::vector<int>& offset_vec, std::vector<size_t>& value_len_vec);
