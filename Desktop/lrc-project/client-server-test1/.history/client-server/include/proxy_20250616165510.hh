...
namespace ClientServer {
    ...
    public:
        ...
        void Repair_degrade(std::string message,int num,int *node_id,const int fail_offset, size_t fail_value_len,const int *offset,const size_t* value_len,string &value,const char ** data_already_get);
