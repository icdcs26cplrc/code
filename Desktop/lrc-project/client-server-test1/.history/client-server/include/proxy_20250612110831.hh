...
namespace ClientServer {
    ...
    public:
        ...
        void Repair_degrade(std::string message,int num,int *node_id,const int *fail_offset,const int *offset,size_t* value_len,string &value);
    ...
    private:
        ...
        void GetRevDataWithErrorHandling(char** data, int num, const size_t* value_lens, size_t*& recv_len, const std::vector<bool>& request_success) ;
