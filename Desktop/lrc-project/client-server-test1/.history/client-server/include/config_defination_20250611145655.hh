...
// 数据节点端口宏定义（新增）
#define DATANODE_PORT_0 getDatanodePort()[0].c_str()
#define DATANODE_PORT_1 getDatanodePort()[1].c_str()
#define DATANODE_PORT_2 getDatanodePort()[2].c_str()
#define DATANODE_PORT_3 getDatanodePort()[3].c_str()
#define DATANODE_PORT_4 getDatanodePort()[4].c_str()
#define DATANODE_PORT_5 getDatanodePort()[5].c_str()
#define DATANODE_PORT_6 getDatanodePort()[6].c_str()
#define DATANODE_PORT_7 getDatanodePort()[7].c_str()
#define DATANODE_PORT_8 getDatanodePort()[8].c_str()
#define DATANODE_PORT_9 getDatanodePort()[9].c_str()
