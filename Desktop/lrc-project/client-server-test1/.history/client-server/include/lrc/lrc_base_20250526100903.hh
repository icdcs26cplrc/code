...
namespace ClientServer
{
    ...
    protected:
        ...
        virtual int single_decode_node_need(int fail_one, int *&node_id) = 0;
        virtual bool single_decode(int fail_one, char **data_ptrs, char **code_ptr) = 0;
        virtual bool muti_single_decode(int fail_num, int *fail_list, char **data_ptrs, char **global_code_ptr, char **local_ptr) = 0;
    ...
    public:
        ...
        virtual bool muti_decode(int fail_num, int *fail_list, char **data_ptrs, char **global_code_ptr, char **local_ptr);
        ...
        virtual bool mds_decode(int locality, int fail_num, int *fail_list, char **data_ptrs, char **code_ptr);
