#ifndef UNIFORM_LRC_HH
#define UNIFORM_LRC_HH
...
{
    class UNIFORM_LRC : public LRC_BASE
    {
    private:
        int k_;
        int r_;
    ...
    public:
        UNIFORM_LRC(int data, int global, int local, size_t BlockSize);
        // void uniform_encode(int k, int r, int p, char **data_ptrs, char **global_coding_ptrs,char **local_coding_ptrs, int blocksize);
        ...
        bool single_decode(int fail_one, char **data_ptrs, char **code_ptr ) override;
        bool muti_single_decode(int fail_num, int *fail_list, char **data_ptrs, char **global_code_ptr, char **local_ptr) override;
