...
int SEP_AZURE::single_decode_node_need(int fail_one, int *&node_id, int group_id__)
{
    int return_group_size;
    // top层出错(k+r-1 - k+r+p-1)
...
bool SEP_AZURE::single_decode(int fail_one, char **data_ptrs, char **code_ptr, size_t decode_size)
{
...
bool SEP_AZURE::muti_single_decode(int fail_num, int *fail_list, char **data_ptrs, char **global_code_ptr, char **local_ptr, size_t decode_size)
{
    int *group_id;
